	...
	return (
		<html lang="en">
			<body className={inter.className}>
				<main className="flex flex-col items-center mb-0 custombg 2xl:pb-20">
					<div className="relative">
						<a
							href="https://wa.me/543425138732?text=I'm%20inquiring%20about%20the%20apartment%20listing"
							target="_blank"
						>
							<svg
								className="fixed right-0 w-20 sm:top-0 z-30 xl:bottom-10 xl:right-10"
